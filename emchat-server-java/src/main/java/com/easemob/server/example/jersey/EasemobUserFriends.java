 ...
 * 
 */
public class EasemobUserFriends {

	/** LOGGER */
	private static Logger LOGGER = LoggerFactory.getLogger(EasemobUserFriends.class);
	 ...
	 * 在这个app下创建一个新的用户
	 */
	public static List<String> crateaNewImUser(UsernamePasswordCredentail credentail, String appKey,
			Map<String, Object> reqBody) {
		JsonNode jsonNode = null;
	 ...
	 * 在这个app下批量创建用户
	 */
	public static List<String> crateaNewImUserBatch(UsernamePasswordCredentail credentail, String appKey,
			Map<String, Object> reqBody) {
		JsonNode jsonNode = null;
